...
class Net(torch.nn.Module):
    def __init__(self, out_channels, aggr='max'):
        ...
        self.conv1 = EdgeConv(nn.Linear(2 * 4, 64), aggr)
        ...
        # self.mlp = nn.Linear(64 * 128, 1024)
...
scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[50, 100, 200, 300, 400], gamma=0.8)
